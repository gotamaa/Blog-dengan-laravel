                ...
                <div class="hidden md:block">
                    <div class="ml-4 flex items-center md:ml-6">
                        <div class="relative ml-3 flex items-center">
                            ...
                            @auth
                                <a href="#" class="ml-3 text-sm font-medium text-white hover:text-gray-400">
                                    {{ Auth::user()->name }}
                                </a>
                            </div>
                        @endauth
                            ...
                            <div x-show="isOpen" x-transition:enter="transition ease-out duration-100 transform"
                                ...
                                @else
                                    <a href="{{ route('login') }}" class="block px-4 py-2 text-sm text-gray-700"
                                        role="menuitem" tabindex="1" id="user-menu-item-3">Sign in</a>
                                @endauth
                                <a href="#" class="block px-4 py-2 text-sm text-gray-700" role="menuitem"
                                    tabindex="2" id="user-menu-item-3">Settings</a>
                            </div>
                        </div>
                    </div>
                </div>
