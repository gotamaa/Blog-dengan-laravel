...
<body>
    @forelse ($posts as $post)
        <article
            class="relative p-6 bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
            <div x-data="{ isOpen: false }" class="menu-button">
                ...
                <div x-show="isOpen" @click.away="isOpen = false"
                    ...
                    <!-- Menu items -->
                    <a href="{{ route('manageposts.update', $post->id) }}" class="block px-4 py-2 text-sm text-gray-700"
